...
describe("ViewingBookService", () => {
  ...
  it("should throw error when lead not found", async () => {
    ...
    await expect(
      ViewingBookService.decorator.viewingBookService.bookViewing("agency-test-1", input),
  ...
  it("should return viewingId and confirmedAt when lead exists and booking succeeds", async () => {
    ...
    const result =
      await ViewingBookService.decorator.viewingBookService.bookViewing("agency-test-1", input);
